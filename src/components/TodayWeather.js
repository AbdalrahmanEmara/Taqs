  ...
  return (
    <div className="today-weather col-span-3 lg:col-span-1 bg-slate-800 rounded-lg p-5">
      ...
      <div className="main-info flex flex-col items-center">
        ...
        <span className="text-6xl font-bold">{Math.round(tempType === 'C' ? weather.tempC : weather.tempF)}°</span>
      ...
      <div className="other-weather-info flex flex-wrap gap-3 mt-7">
        <OtherWeatherInfo type={"Feels Like"} value={`${Math.round(tempType === 'C' ? weather.feelsLikeC : weather.feelsLikeF)}°`} />
